...
#include "Velt/Layers/LayerStack.h"
...
namespace Velt {
	namespace RenderAPI {
		...
		void Renderer::createPipeline()
		{
			...
			Velt::RenderAPI::Pipeline::defaultPipelineConfigInfo(pipelineConfig);
		...
		void Renderer::drawFrame()
		{
			...
			{
				VT_CORE_ERROR("Failed to acquire swap chain image!");
			...
			{
				VT_CORE_ERROR("Failed to present swap chain image!");
		...
		{
			VT_PROFILE_FUNCTION();
			VT_CORE_INFO("Renderer shutdown");
			...
			VT_CORE_INFO("Renderer shutdown complete");
		}
