...
namespace Lavendel
{
    class LAVENDEL_API MouseMovedEvent : public Event
    {
    public:
    ...
    class LAVENDEL_API MouseButtonEvent : public Event
    {
    ...
    class LAVENDEL_API MouseButtonPressedEvent : public MouseButtonEvent
    {
    public:
